                        ...
                        <tbody>
                            <tr>
                                <td style="text-align: center; padding-bottom:25px">
                                    <a href="#"><img style="height: 40px" src="{{ asset('img/logo-dark-01.png') }}" alt="logo"></a>
                        ...
                        <tbody>
                            <tr>
                                <td style="padding: 30px 30px 20px">
                                    ...
                                    <p style="margin-bottom: 10px;">We are pleased to have you as a member of Techara.</p>
                                    <p style="margin-bottom: 10px;">Your account details are being verified. You will receive a confirmation email once everything checks out.</p>
                                    <p style="margin-bottom: 15px;">Hope you'll enjoy the experience, we're here if you have any questions, drop us a line at <a style="color: #6576ff; text-decoration:none;" href="mailto:hey@techara.co.ke">hey@techara.co.ke</a> anytime. </p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            <tr>
                                <td style="text-align: center; padding:25px 20px 0;">
                                    <p style="font-size: 13px;">Copyright © 2020 Techara. All rights reserved.</p>
                                    ...
                                    {{-- <p style="padding-top: 15px; font-size: 12px;">This email was sent to you as a registered user of <a style="color: #6576ff; text-decoration:none;" href="https://techara.co.ke">techara.co.ke</a>. To update your emails preferences <a style="color: #6576ff; text-decoration:none;" href="techara.co.ke">click here</a>.</p> --}}
                                </td>
                            </tr>
                        </tbody>
                    </table>
